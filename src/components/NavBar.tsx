...
const Header = () => {
  ...
  return (
    <>
      <nav className="fixed z-10 w-full mx-auto bg-blue-200 bg-opacity-70 border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-black/40 dark:bg-opacity-80 drop-shadow-md dark:drop-shadow-[0_10px_15px_rgba(255,255,255,0.25)]">
        <div className="max-w-[1080px] container flex flex-wrap justify-between items-center mx-auto">
          <Link href="/" className="flex items-center flex-1">
            <span className="flex flex-row items-center self-center text-2xl font-bold whitespace-nowrap text-[#732fff] hover:text-[#a137df] dark:text-[#00bdff]">
              <Image
                ...
                <Popover trigger={"hover"} placement={"bottom-start"}>
                  ...
                  <PopoverContent className="bg-blue-100 bg-opacity-80 box-border h-25 w-35 dark:bg-black/40 dark:bg-opacity-80 dark:text-white/80 shadow-lg rounded-xl border-1 p-4 min-w-sm">
                    ...
                    >
                      <Stack direction={"row"} align={"center"}>
                        <Box>
                          <Text className="font-semibold transition ease-in-out delay-10 group-hover:blue-400">
                            {"Distrubutor"}
                          </Text>
                        </Box>
                        <Flex className="transition ease-in-out delay-10 opacity-0 -translate-x-10 group-hover:opacity-100 group-hover:translate-x-0 justify-flex-end flex self-center flex-1">
